defmodule HaikuterWeb.Router do
  ...
  scope "/", HaikuterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{HaikuterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", HaikuterWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{HaikuterWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", HaikuterWeb do
    ...
    live_session :current_user,
      on_mount: [{HaikuterWeb.UserAuth, :mount_current_user}] do
